...
import { cleanTweet, processThread, isValidTweet, type TweetPreprocessingOptions } from './tweet-preprocessor';
...
function displayResults(tweets: string[], options: TweetPreprocessingOptions, optionName: string) {
